...
The data we will use is available through this package. 
```{r}
pep_infile <- system.file(
  "extdata", "RBPMap_RNase_pilot_3/LFQ_OOPS_RNase_PeptideGroups.txt", 
  package = "Proteomics.data.analysis"
)

pep_data <- read.delim(pep_infile)
```
